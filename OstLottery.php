...
class OstLottery extends Plugin
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_lottery.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_lottery.view_dir', $this->getPath() . '/Resources/views/');
